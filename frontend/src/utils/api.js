...
export const closeTradeManually = (tradeId) => api.post(`/trades/${tradeId}/close`)
...
export const fetchScanShortlist = () => api.get('/agent/scan-shortlist')
...
export const searchCoins       = (query, limit = 8) => api.get('/coins/search', { params: { q: query, limit } })
